...
class VirtualMachineDeployer(object):
    ...
    def cluster_ssh(self):
        ...
        try:
            cmd = ['ssh', '-i', get_key_path(), self.master_ssh_login()]
    ...
    def mount_shares(self):
        ...
        key_file = os.path.basename(get_key_path())
        ...
        self.scp_to_master(get_key_path(), key_file)
	...
	def public_ip(self):
		public_ip_address = self.network.public_ip_addresses.get(self.group_name, vm_name)
